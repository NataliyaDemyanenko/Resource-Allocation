...
tk.Label(root, text="Party").grid(row=0)
tk.Label(root, text="Votes needed").grid(row=1)
tk.Label(root, text="State").grid(row=2, column=1)
tk.Label(root, text="Abbr.").grid(row=2, column=2)
tk.Label(root, text="Color").grid(row=2, column=3)
tk.Label(root, text="Electoral votes").grid(row=2, column=4)
